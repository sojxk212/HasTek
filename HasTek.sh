...
import os
import webbrowser
webbrowser.open('https://t.me/mohme771')

print('''\033[95m
قسم البلاغ عن حسابات التيك توك 
_   _          _____    _
| | | | __ _ __|_   _|__| | __
| |_| |/ _` / __|| |/ _ \ |/ /
|  _  | (_| \__ \| |  __/   <
...
\033[0m''')
print('''\033[94m[+] الرجاء قم بالاختيار  :'\033[0m''')
print(''' \033[92m[+] ابلاغ في نفس الوقت اكتب رقم  - 1\033[0m''')
print(''' \033[92m[+] اختيار  من نفسك  الإبلاغ اكتب رقم - 2\033[0m''')
a5tar = input('''\033[93m[+] اكتب رقم الاختيار  ==> : \033[0m''')
os.system('clear')
print('''\033[93m
قسم البلاغ عن حسابات التيك توك 
_   _          _____    _
...
\033[0m''')
webbrowser.open('https://api.whatsapp.com/send?phone=+967738325474')
if a5tar == '1':
    time.sleep(1)
    print(''' \033[94m
[+] اول نوع ابلاغ عادي  :
[+] نوع الثاني ابلاغ كراهيه  :
[+] نوع الثالث ابلاغ انتحاري  :
\033[0m''')
    time.sleep(1)
    print(''' \033[91m[!]سيتم الابلاغ باسرع وقت الكنج حمودي الاسطوره ملك مجالك :\033[0m''')
    time.sleep(1)
    print("")
    id1 = input(''' \033[96m[+] ادخل يوزر الضحيه  ==> : \033[0m''')
    print(''' \033[92m[+] سيتم ابتدا البلاغات  ـ :\033[0m''')
    ...
    while True:
        ...
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نٌشّـكَرَكَ عَلَى مِـلَآحً ـظٌـآتُكَ"},"errMsg":"نٌشّـكَرَكَ عَلَى مِـلَآحً ـظٌـآتُكَ"}' in req1:
            print('[+] تُمِـ آلَآبّـلَآغّ ـ فُيّ آلَنٌوُعَ - عَآدُيّ')
        else:
            print('[-] حً ـدُثًـ خٌ ـطٌـآء فُيّ آلَآبّـلَآغّ ـ فُيّ آلَنٌوُعَ - عَآدُيّ')
        time.sleep(3)
        req2 = requests.post(url2, json=data2, headers=headers2).text
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نٌشّـكَرَكَ عَلَى مِـلَآحً ـظٌـآتُكَ"},"errMsg":"نٌشّـكَرَكَ عَلَى مِـلَآحً ـظٌـآتُكَ"}' in req2:
            print('[+] تُمِـ آلَآبّـلَآغّ ـ فُيّ آلَنٌوُعَ - كَرَآهِيّ')
        else:
            print('[-] حً ـدُثًـ حً ـطٌـآء فُيّ آلَآبّـلَآغّ ـ فُيّ آلَنٌوُعَ - كَرَآهِيّ')
        time.sleep(3)
        req3 = requests.post(url3, json=data3, headers=headers3).text
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نٌشّـكَرَكَ عَلَى مِـلَآحً ـظٌـآتُكَ"},"errMsg":"نٌشّـكَرَكَ عَلَى مِـلَآحً ـظٌـآتُكَ"}' in req3:
            print('[+] تُمِـ آلَآبّـلَآغّ ـ فُيّ آلَنٌوُعَ - آنٌتُحً ـآرَ')
        else:
            print('[-] حً ـدُثًـ حً ـطٌـآء فُيّ آلَآبّـلَآغّ ـ فُيّ آلَنٌوُعَ - آنٌتُحً ـآرَ')
if a5tar == '2':
    print(''' \033[93m
[+] النوع الاول ابلاغ عادي  [1]
[+] النوع  الثاني ابلاغ  كراهيه  ِـ [2]
[+] النوع الثالث  ابلاغ انتحاري ِـ [3]
\033[0m''')
a5tar2 = input('''\033[92mاختيار نوع البلاغ ِـ ==> : \033[0m''')
if a5tar2 == '1':
    username = input('''\033[95m[+] ادخل يوزر الضحيه ==> : \033[0m''')
    ...
    while True:
        ...
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نٌشّـكَرَكَ عَلَى مِـلَآحً ـظٌـآتُكَ"},"errMsg":"نٌشّـكَرَكَ عَلَى مِـلَآحً ـظٌـآتُكَ"}' in req5:
            print('[+] تُمِـ آلَآبّـلَآغّ ـ')
        else:
            print('[-] حً ـدُثًـ خٌ ـطٌـآء فُيّ آلَآبّـلَآغّ ـ')
if a5tar2 == '2':
    username2 = input('[+] آدُخٌ ـلَ يّوُزَرَ آلَشّـخٌ ـصِـ آلَيّ بّـتُبّـلَغّ ـ عَلَيّهِ ==> : ')
    ...
    while True:
        ...
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نٌشّـكَرَكَ عَلَى مِـلَآحً ـظٌـآتُكَ"},"errMsg":"نٌشّـكَرَكَ عَلَى مِـلَآحً ـظٌـآتُكَ"}' in req6:
            print('[+] تُمِـ آلَآبّـلَآغّ ـ')
        else:
            print('[-] حً ـدُثًـ حً ـطٌـآء فُيّ آلَآبّـلَآغّ ـ')
if a5tar2 == '3':
    username3 = input('[+] آدُخٌ ـلَ يّوُزَرَ آلَشّـخٌ ـصِـ آلَيّ بّـتُبّـلَغّ ـ عَلَيّهِ ==> : ')
    ...
    while True:
        ...
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نٌشّـكَرَكَ عَلَى مِـلَآحً ـظٌـآتُكَ"},"errMsg":"نٌشّـكَرَكَ عَلَى مِـلَآحً ـظٌـآتُكَ"}' in req600:
            print('[+] تُمِـ آلَآبّـلَآغّ ـ')
        else:
            print('[-] حً ـدُثًـ حً ـطٌـآء فُيّ آلَآبّـلَآغّ ـ')
